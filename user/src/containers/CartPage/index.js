  ...
  return (
    <Layout>
      <div className="cartContainer" style={{ alignItems: "flex-start" }}>
        ...
        >
          ...
          {/* <div style={{ width: "250px" }}>
            ...
            //onClick={() => props.history.push(`/checkout`)}
            /> */}
            <form action="http://localhost:2000/events" method="POST">
              <label for="attendee email">Attendee email</label>
              <input type="email" name="to" placeholder="send email to..."></input>
      ...
      <input type="submit" value="Send Event Invite"> */}
              <input type="submit" value="Send Event Invite"></input>
            </form>
          </div>
          {/* </div> */}
        </Card>
