...
router.post('/events', (req) =>{
  ...
  const event = {
    summary:"Pick Your Order",
    description: "Please pay and collect your Order from LiveMart Retailer",
    colorId: 6,
    start: {
  ...
  const msg = {
    ...
    subject: 'Your Order',
    text: 'ThankYou for shopping with LiveMart',
